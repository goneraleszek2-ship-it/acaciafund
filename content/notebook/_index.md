...
Ostatnia aktualizacja: `2026-05-21 09:48 UTC`  •  Posty: `231`  •  Punkty: `93673⭐`  •  Linki: `2814`</div>
</div>
<div class="cell">
  <div class="cell-header">
...
latest = [
  {"date": "2026-05-21", "score": 1187, "links": 12},
...
<div class="cell">
  ...
  <div class="cell-content"><table style='font-size:.82rem'><tr><th>Pillar</th><th>Posts</th><th>Total ⭐</th><th>Links</th><th>Avg ⭐</th></tr><tr><td>🛡️ AML</td><td>77</td><td>9918</td><td>717</td><td>26.0</td></tr><tr><td>📈 Markets</td><td>77</td><td>61892</td><td>1074</td><td>114.8</td></tr><tr><td>🧬 Science</td><td>77</td><td>21863</td><td>1023</td><td>45.1</td></tr></table></div>
</div>
<div class="cell">
  <div class="cell-header">
...
<div class="cell">
  ...
  <div class="cell-content"><div class="chart-wrap" style="text-align:center"><h4>Rozkład punktów ⭐</h4><svg viewBox="0 0 240 180" xmlns="http://www.w3.org/2000/svg" style="max-width:100%;height:auto;font-family:Inter,system-ui,sans-serif"><path d="M120,90 L120.0,20.0 A70,70 0 0,1 163.2,34.9 Z" fill="#3B6999" opacity=".85"/>
<text x="151" y="1" text-anchor="middle" font-size="10" font-weight="600" fill="#3B6999">9918⭐</text>
<path d="M120,90 L163.2,34.9 A70,70 0 1,1 50.4,82.7 Z" fill="#C47F58" opacity=".85"/>
<text x="157" y="177" text-anchor="middle" font-size="10" font-weight="600" fill="#C47F58">61892⭐</text>
<path d="M120,90 L50.4,82.7 A70,70 0 0,1 120.0,20.0 Z" fill="#9C6B8E" opacity=".85"/>
<text x="57" y="20" text-anchor="middle" font-size="10" font-weight="600" fill="#9C6B8E">21863⭐</text>
<circle cx="120" cy="90" r="35.0" fill="#fff"/>
<text x="120" y="94" text-anchor="middle" font-size="13" font-weight="700" fill="#0d1b2a">93673</text></svg></div></div>
</div>
<div class="cell">
  <div class="cell-header">
...
<text x="8" y="31" font-size="9" fill="#374151">trending</text>
...
<text x="8" y="49" font-size="9" fill="#374151">raport</text>
...
<text x="8" y="67" font-size="9" fill="#374151">algolia</text>
...
<text x="8" y="85" font-size="9" fill="#374151">klasyfikacja</text>
...
<text x="8" y="103" font-size="9" fill="#374151">podsumowanie</text>
<rect x="100" y="92" width="370" height="14" rx="2" fill="#3B6999" opacity=".7"/>
<text x="104" y="103" font-size="8" font-weight="500" fill="#fff">75</text>
<text x="8" y="121" font-size="9" fill="#374151">dzisiaj</text>
<rect x="100" y="110" width="370" height="14" rx="2" fill="#3B6999" opacity=".7"/>
<text x="104" y="121" font-size="8" font-weight="500" fill="#fff">75</text>
<text x="4" y="170" font-size="11" font-weight="600" fill="#C47F58">📈 Markets</text>
<text x="8" y="189" font-size="9" fill="#374151">news</text>
<rect x="100" y="178" width="380" height="14" rx="2" fill="#C47F58" opacity=".7"/>
<text x="104" y="189" font-size="8" font-weight="500" fill="#fff">80</text>
<text x="8" y="207" font-size="9" fill="#374151">trending</text>
<rect x="100" y="196" width="366" height="14" rx="2" fill="#C47F58" opacity=".7"/>
<text x="104" y="207" font-size="8" font-weight="500" fill="#fff">77</text>
<text x="8" y="225" font-size="9" fill="#374151">podsumowanie</text>
<rect x="100" y="214" width="366" height="14" rx="2" fill="#C47F58" opacity=".7"/>
<text x="104" y="225" font-size="8" font-weight="500" fill="#fff">77</text>
<text x="8" y="243" font-size="9" fill="#374151">dzisiaj</text>
<rect x="100" y="232" width="366" height="14" rx="2" fill="#C47F58" opacity=".7"/>
<text x="104" y="243" font-size="8" font-weight="500" fill="#fff">77</text>
<text x="8" y="261" font-size="9" fill="#374151">analiza</text>
<rect x="100" y="250" width="366" height="14" rx="2" fill="#C47F58" opacity=".7"/>
<text x="104" y="261" font-size="8" font-weight="500" fill="#fff">77</text>
<text x="8" y="279" font-size="9" fill="#374151">hacker</text>
<rect x="100" y="268" width="366" height="14" rx="2" fill="#C47F58" opacity=".7"/>
...
<text x="8" y="347" font-size="9" fill="#374151">news</text>
<rect x="100" y="336" width="380" height="14" rx="2" fill="#9C6B8E" opacity=".7"/>
<text x="104" y="347" font-size="8" font-weight="500" fill="#fff">78</text>
<text x="8" y="365" font-size="9" fill="#374151">trending</text>
<rect x="100" y="354" width="375" height="14" rx="2" fill="#9C6B8E" opacity=".7"/>
<text x="104" y="365" font-size="8" font-weight="500" fill="#fff">77</text>
<text x="8" y="383" font-size="9" fill="#374151">podsumowanie</text>
<rect x="100" y="372" width="375" height="14" rx="2" fill="#9C6B8E" opacity=".7"/>
<text x="104" y="383" font-size="8" font-weight="500" fill="#fff">77</text>
<text x="8" y="401" font-size="9" fill="#374151">dzisiaj</text>
<rect x="100" y="390" width="375" height="14" rx="2" fill="#9C6B8E" opacity=".7"/>
<text x="104" y="401" font-size="8" font-weight="500" fill="#fff">77</text>
<text x="8" y="419" font-size="9" fill="#374151">nauka</text>
<rect x="100" y="408" width="375" height="14" rx="2" fill="#9C6B8E" opacity=".7"/>
<text x="104" y="419" font-size="8" font-weight="500" fill="#fff">77</text>
<text x="8" y="437" font-size="9" fill="#374151">hacker</text>
<rect x="100" y="426" width="375" height="14" rx="2" fill="#9C6B8E" opacity=".7"/>
...
1. **Dominacja AML** — 9918⭐ to najwyższa suma, co odzwierciedla intensywność dyskursu regulacyjnego.
