...
# Using a project-relative path so the Shrinkwrap build has permission to compile it
@lightweight(test_source=LightweightOutput(path="/Acacia/acaciafund-pipeline/mock_source_data"))
def create_test_data(test_source: "DataFrame") -> None:                  
    df = pd.DataFrame({
