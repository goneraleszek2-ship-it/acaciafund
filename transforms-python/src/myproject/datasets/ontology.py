...
@transform.using(
    output=Output("/TierPalan-95733d/Acacia/acaciafund-pipeline/ontology_concepts"),
...
@transform.using(
    output=Output("/TierPalan-95733d/Acacia/acaciafund-pipeline/ontology_relationships"),
    sources=Input("/TierPalan-95733d/Acacia/acaciafund-pipeline/acacia_portal_clean_data"),
)
def relationships(
    sources: LightweightInput,
