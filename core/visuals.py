...
def render_topic_icon(key: str, accent: str = "currentColor") -> str:
    ...
    if is_brand:
        return (f'<g color="{accent}" fill="currentColor">'
                f'{path_str}</g>')
    else:
        return (f'<g color="{accent}" fill="none" stroke="currentColor" '
...
def get_brand_topic_slugs() -> list[str]:
    ...
    return [e["slug"] for e in TOPIC_ICONS.values()
            if e["type"] == "brand"]
...
TOPIC_ICONS: dict[str, dict] = {
    ...
    # AML pillar
    "regulation":    {"type": "abstract", "paths": '<path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/>'},
    "compliance":    {"type": "abstract", "paths": '<rect x="3" y="3" width="18" height="18" rx="2"/><path d="M9 12l2 2 4-4"/>'},
    "crypto":        {"type": "abstract", "paths": '<circle cx="12" cy="12" r="10"/><path d="M12 6v12M9 9h6l-3 6-3-6z"/>'},
    "fraud":         {"type": "abstract", "paths": '<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><circle cx="12" cy="12" r="3"/>'},
    "banking":       {"type": "abstract", "paths": '<rect x="2" y="8" width="20" height="14" rx="2"/><path d="M12 2L2 8h20L12 2z"/><path d="M8 14v4M12 14v4M16 14v4"/>'},
    # Markets pillar
    "semiconductor": {"type": "abstract", "paths": '<path d="M6 6h12v12H6z"/><path d="M8 8h8v8H8z"/><path d="M10 10h4v4h-4z"/>'},
    "ai":            {"type": "abstract", "paths": '<circle cx="12" cy="12" r="10"/><path d="M12 8v8M8 12h8"/><circle cx="12" cy="12" r="3"/>'},
    "stock_market":  {"type": "abstract", "paths": '<path d="M2 20h20M6 16l4-4 4 4 4-8"/>'},
    "startup":       {"type": "abstract", "paths": '<path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5"/><path d="M12 22V12"/>'},
    "manufacturing": {"type": "abstract", "paths": '<path d="M4 4h16v16H4z"/><circle cx="12" cy="12" r="4"/><path d="M12 8v8M8 12h8"/>'},
    # Science pillar
    "dna":           {"type": "abstract", "paths": '<path d="M8 2c0 0 0 20 8 20M16 2c0 0 0 20-8 20M8 12h8"/>'},
    "quantum":       {"type": "abstract", "paths": '<circle cx="12" cy="12" r="3"/><circle cx="16" cy="8" r="1.5"/><circle cx="16" cy="16" r="1.5"/><circle cx="8" cy="8" r="1.5"/><circle cx="8" cy="16" r="1.5"/><path d="M12 3v2M12 19v2M3 12h2M19 12h2"/>'},
    "brain":         {"type": "abstract", "paths": '<path d="M12 2C8 2 4 5 4 10c0 3 2 5 2 5s0 5 6 5 6-5 6-5 2-2 2-5c0-5-4-8-8-8z"/><path d="M9 10h6M10.5 12h3M10 8h4"/>'},
    "space":         {"type": "abstract", "paths": '<circle cx="12" cy="12" r="10"/><path d="M2 12h20M12 2a16 16 0 010 20 16 16 0 010-20z"/><ellipse cx="12" cy="12" rx="4" ry="10"/>'},
    "climate":       {"type": "abstract", "paths": '<circle cx="12" cy="12" r="10"/><path d="M12 2a8 8 0 000 16"/><path d="M8 6l2 2M16 6l-2 2"/>'},
    # Data Engineering subtopics (abstract)
    "pipeline":      {"type": "abstract", "paths": '<path d="M3 12h5l2-3 4 6 2-3h5"/><circle cx="3" cy="12" r="2"/><circle cx="21" cy="12" r="2"/><path d="M10 6h4M10 18h4"/>'},
    "storage":       {"type": "abstract", "paths": '<ellipse cx="12" cy="6" rx="8" ry="3"/><path d="M4 6v6c0 1.66 3.58 3 8 3s8-1.34 8-3V6"/><path d="M4 12v6c0 1.66 3.58 3 8 3s8-1.34 8-3v-6"/>'},
    "quality":       {"type": "abstract", "paths": '<path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>'},
    "streaming":     {"type": "abstract", "paths": '<path d="M18.36 6.64a9 9 0 11-12.73 0M12 2v8M9 7l3-3 3 3"/>'},
    "infrastructure":{"type": "abstract", "paths": '<rect x="4" y="4" width="16" height="16" rx="2"/><path d="M9 4v16M15 4v16M4 9h16M4 15h16"/>'},
}
...
_BRANDS_DATA: dict[str, set[str]] = {
    ...
    "amazonaws":       {"aws", "amazon web services", "s3", "ec2", "lambda", "emr", "athena", "glue", "redshift"},
...
BRAND_ICON_KEYWORDS: dict[str, set[str]] = {
    k: v for k, v in _BRANDS_DATA.items()
}
