...
ARXIV_KEYWORDS = {
    ...
    "data-engineering": ["data pipeline", "etl", "elt", "data lake", "data warehouse",
                         "data lakehouse", "data quality", "data lineage", "data catalog",
                         "data mesh", "data product", "data contract", "orchestration",
                         "workflow", "dag", "stream processing", "batch processing",
                         "apache spark", "apache flink", "apache kafka", "apache beam",
                         "iceberg", "delta lake", "parquet", "arrow", "duckdb",
