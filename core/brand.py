...
_MICRO_ICONS: dict[str, str] = {
    "time": (
        ...
        '<line x1="8" y1="4" x2="8" y2="8" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>'
        '<line x1="8" y1="8" x2="11" y2="10" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"/>'
    ),
    "source": (
        # Document with arrow
        '<rect x="2" y="1" width="9" height="12" rx="1.5" fill="none" stroke="currentColor" stroke-width="1.5"/>'
        '<path d="M5 4h3M5 6h5M5 8h4" stroke="currentColor" stroke-width="1" stroke-linecap="round" opacity="0.6"/>'
        '<path d="M11 7l3 0 0-3" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" fill="none"/>'
        '<path d="M14 4l-3 3" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"/>'
    ),
    "difficulty": (
        # 3-tier bars (ascending)
        '<rect x="1" y="10" width="3" height="5" rx="0.8" fill="currentColor" opacity="0.4"/>'
        '<rect x="6.5" y="6" width="3" height="9" rx="0.8" fill="currentColor" opacity="0.7"/>'
        '<rect x="12" y="1" width="3" height="14" rx="0.8" fill="currentColor"/>'
    ),
    "domain": (
        # 3 overlapping circles (Venn)
        '<circle cx="8" cy="6" r="4" fill="none" stroke="currentColor" stroke-width="1.3"/>'
        '<circle cx="5.5" cy="10" r="4" fill="none" stroke="currentColor" stroke-width="1.3"/>'
        '<circle cx="10.5" cy="10" r="4" fill="none" stroke="currentColor" stroke-width="1.3"/>'
    ),
    "version": (
        # Tag with dot
        '<path d="M1 8.5V2.5a1.5 1.5 0 011.5-1.5H9l5.5 5.5-7 7L1 8.5z" '
        'fill="none" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/>'
        '<circle cx="4.5" cy="5.5" r="1.2" fill="currentColor"/>'
    ),
    "tags": (
        # Tag stack
        '<path d="M1 9V3a1 1 0 011-1h6l6 6-6 6-7-7z" fill="none" stroke="currentColor" stroke-width="1.4"/>'
    ...
    "calendar": (
        # Calendar
        '<rect x="1.5" y="3" width="13" height="11" rx="1.5" fill="none" stroke="currentColor" stroke-width="1.4"/>'
        '<line x1="1.5" y1="7" x2="14.5" y2="7" stroke="currentColor" stroke-width="1.2"/>'
        '<line x1="5" y1="1.5" x2="5" y2="4.5" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/>'
        '<line x1="11" y1="1.5" x2="11" y2="4.5" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/>'
    ),
    "chart": (
        # Mini bar chart
        '<rect x="1" y="9" width="3" height="6" rx="0.5" fill="currentColor" opacity="0.5"/>'
        '<rect x="5.5" y="5" width="3" height="10" rx="0.5" fill="currentColor" opacity="0.7"/>'
        '<rect x="10" y="2" width="3" height="13" rx="0.5" fill="currentColor"/>'
    ),
}
...
def brand_sparkline(
    ...
    fill = ""
    if show_fill:
        fill = f'<polygon points="{" ".join(fill_points)}" fill="{accent}" opacity="0.15"/>'
