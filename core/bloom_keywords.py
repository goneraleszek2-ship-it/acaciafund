...
UNDERSTAND_KW = re.compile(
    ...
    r"|lesson|walkthrough|demonstrat(?:e|es|ed|ing)|illustrat(?:e|es|ed|ing))\b", re.I
)
APPLY_KW = re.compile(
...
ANALYZE_KW = re.compile(
    ...
    r"pattern(?:s)?|trend(?:s)?"
    r"|correlation|relationship|impact|effect(?:s)?|cause|factor(?:s)?|implication(?:s)?)\b", re.I
)
