...
for idx, mmd_file in enumerate(mmd_files, 1):
    ...
    svg_filepath = os.path.join(docs_dir, '..', 'static', 'images', 'generated', 'knowledge', svg_filename)
    if not os.path.exists(svg_filepath):
        ...
        svg_filepath = os.path.join(docs_dir, '..', 'static', 'images', 'generated', 'knowledge', svg_filename_hyphen)
