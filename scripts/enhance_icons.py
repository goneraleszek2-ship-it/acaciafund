...
NEW_ICONS = {
    ...
    "risk": {"type": "abstract", "paths": '<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><circle cx="12" cy="12" r="3"/><path d="M2 17l10 5 10-5"/>'},
    "sanctions": {"type": "abstract", "paths": '<path d="M2 22l10-10 10 10M2 12l10-10 10 10M2 22V2l10 10 10-10V22"/>'},
    "pep": {"type": "abstract", "paths": '<circle cx="12" cy="8" r="4"/><path d="M12 12v10M8 16h8"/>'},
    "kyc": {"type": "abstract", "paths": '<rect x="4" y="4" width="16" height="16" rx="2"/><path d="M9 9h6v6H9z"/><path d="M12 12l4 4"/>'},
    "fintech": {"type": "abstract", "paths": '<rect x="2" y="4" width="20" height="16" rx="2"/><path d="M6 8h14M6 12h10M6 16h6"/><circle cx="12" cy="12" r="2"/>'},
    "payments": {"type": "abstract", "paths": '<rect x="3" y="3" width="18" height="18" rx="2"/><path d="M9 12h6M12 9v6M9 9l3 3-3 3"/>'},
    "neobank": {"type": "abstract", "paths": '<rect x="2" y="4" width="20" height="16" rx="2"/><path d="M6 8h14M10 12h4M8 16h8"/>'},
    "wealth": {"type": "abstract", "paths": '<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="M12 6v14M8 10h8"/>'},
    "robo": {"type": "abstract", "paths": '<path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5"/><path d="M12 22V12"/><circle cx="12" cy="12" r="3"/>'},
}
