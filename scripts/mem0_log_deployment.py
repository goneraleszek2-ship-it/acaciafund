...
from services.mem0 import log_deployment, save_insight  # noqa: E402
...
def main():
    parser = argparse.ArgumentParser(description="Log deployment to Mem0")
    parser.add_argument("--commit", help="Git commit hash (auto-detected if not provided)")
    parser.add_argument("--branch", default="main", help="Git branch (default: main)")
    parser.add_argument("--pages", type=int, default=0, help="Number of pages generated")
    parser.add_argument("--duration", type=int, default=0, help="Build duration in milliseconds")
    parser.add_argument(
        "--status",
    ...
    parser.add_argument("--json", help="JSON file with deployment data")
