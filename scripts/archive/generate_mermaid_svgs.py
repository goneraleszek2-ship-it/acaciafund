#!/usr/bin/env python3
"""
Generate SVG images for all Mermaid diagrams from .mmd files.
"""
...
# List of diagram .mmd files to process
ORDERED_MMDS = [
    "admin_panel.mmd",
    "build_sequence.mmd",
    "content_model.mmd",
...
def main():
    ...
    for mmd_name in ORDERED_MMDS:
        mmd_path = DOCS_DIR / mmd_name
        ...
        if generate_svg(str(mmd_path), str(svg_path), svg_name.replace(".svg", "")):
            success_count += 1
        else:
            fail_count += 1
