...
def main():
    parser = argparse.ArgumentParser(description="Initialize Mem0 for AcaciaFund")
    parser.add_argument("--seed", action="store_true", help="Seed initial context")
    parser.add_argument("--reset", action="store_true", help="Reset database (deletes mem0.db)")
    parser.add_argument("--status", action="store_true", help="Show Mem0 status")
