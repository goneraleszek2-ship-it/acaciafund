...
CURATED_RELATIONS = {
    ...
    "learn/building-pipelines-dbt-dagster": [
        {"slug": "learn/data-quality-observability-cost", "type": "next", "label": "Next: quality and observability"},
        {"slug": "learn/data-quality-engineering", "type": "reinforcement", "label": "See also: data quality engineering"},
    ...
    "learn/aml-compliance-glossary": [
        {"slug": "learn/money-laundering-mechanisms", "type": "next", "label": "Next: money laundering mechanisms"},
        {"slug": "learn/quiz-aml", "type": "reinforcement", "label": "Test your AML knowledge"},
    ],
    "learn/money-laundering-mechanisms": [
        {"slug": "learn/aml-enforcement-cases", "type": "next", "label": "Next: AML enforcement cases"},
        {"slug": "learn/quiz-aml", "type": "reinforcement", "label": "Test your AML knowledge"},
    ],
